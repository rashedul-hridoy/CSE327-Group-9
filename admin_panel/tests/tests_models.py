...
class TestModels(TestCase):
    ...
    def test_model_Doctor(self):
        doctor_email=Doctor.objects.create(doctor_email="fahim.nilay@northsouth.edu")
    ...
    def test_model_patient(self):
        patient_email=Patient.objects.create(patient_email="faisal1.nilay@northsouth.edu")
